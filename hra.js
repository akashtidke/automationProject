...
const emailid="akashtidke20149@gmail.com"
const passwordid="Google2016#"
...
browserStartPromise
    .then(function (browserObj) {
        ...
        let emailWillBeEnteredPromise = page.type("input[id='input-1']", emailid, { delay: 50 });
        return emailWillBeEnteredPromise;
    }).then(function () {
        let passwordWillBeEnteredPromise = page.type("input[type='password']",passwordid, { delay: 50 });
